...
const cache={}; function load(id){ if(id==='./index') id='./index'; if(cache[id]) return cache[id].exports; const module=cache[id]={exports:{}}; modules[id](module,module.exports,load); return module.exports; } global.QRCode=load('./index');
})(window);
